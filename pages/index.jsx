...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="150" src="https://images-ext-1.discordapp.net/external/Gh-oMxky2XBHHloa8Y21ivf-UsXHriYP6alK7Hdc5RM/https/cdn.discordapp.com/avatars/931685972733751337/73bbcfb7a61f024a7e70d0cf423d881d.webp" />
      </div>
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://cdn.discordapp.com/attachments/1023329896946217101/1039641733056712704/image.png"  width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
                ...
                <img src="https://cdn.discordapp.com/attachments/1023329896946217101/1039641733056712704/image.png" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
              </>
