...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/AhEAKhcRQG",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=931685972733751337&scope=bot+applications.commands&permissions=2147483656",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/931685972733751337/vote",
    },
    {
      link: true,
      name: "Partners",
