            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        <img width="32" className="rounded-full icon-glow" src="https://cdn.discordapp.com/attachments/1023329896946217101/1043255666153902190/m-icon-3.jpg" />
                ...
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            <img src="https://cdn.discordapp.com/attachments/1023329896946217101/1043255666153902190/m-icon-3.jpg" 
                                className={`
                                    rounded-full 
                                `}
                                width="48" height="48"
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">Moon Plus</span>Bots</a>
                            </p>
                        </div>
